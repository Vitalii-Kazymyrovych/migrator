...
public class SmokeFireNotificationsMigrator extends BaseMigratorSupport implements TableMigrator {

    public SmokeFireNotificationsMigrator(JdbcTemplate sourceJdbcTemplate, JdbcTemplate destinationJdbcTemplate) {
        super(sourceJdbcTemplate, destinationJdbcTemplate);
    }

    @Override
    public String tableName() {
        return "smoke_fire_notifications";
    }

    @Override
    public void migrate() {
        directCopy("smoke_fire_notifications", "smoke_fire_notifications", this::transform);
    }
